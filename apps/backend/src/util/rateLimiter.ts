...
export class RateLimiter {
    ...
    async waitIfNeeded(): Promise<void> {
        ...
        if (this.requestCount % 10 === 0) {
            logger.info(`📊 Rate limiter processed ${this.requestCount} requests`, this.getStats());
        }
    }
 ...
 * KIS API limit: approximately 2-3 requests per second
 */
export const kisRateLimiter = new RateLimiter(2);
