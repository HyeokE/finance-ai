 ...
 */
export const EXCHANGE_CODES: Record<Market, string> = {
    [Market.DOMESTIC]: 'KRX',
    [Market.US]: 'NAS', // Default to NASDAQ, can be NYS or AMS
    [Market.HONG_KONG]: 'HKS',
    [Market.JAPAN]: 'TSE',
    [Market.CHINA]: 'SHS', // Shanghai, can be SZS for Shenzhen
};
...
export interface Position {
    ...
    market?: Market; // Market type (domestic/overseas)
